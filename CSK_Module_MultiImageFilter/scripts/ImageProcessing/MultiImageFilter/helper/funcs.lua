...
funcs.json = require('ImageProcessing/MultiImageFilter/helper/Json')
-- Default parameters for instances of module
funcs.defaultParameters = require('ImageProcessing/MultiImageFilter/MultiImageFilter_Parameters')
