-- Block namespace
local BLOCK_NAMESPACE = 'MultiImageFilter_FC.Process'
...
local function process(handle, imageSource, transformationSource)
  ...
  return 'CSK_MultiImageFilter.OnNewImage' .. tostring(instance)
end
